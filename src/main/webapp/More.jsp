                ...
                <c:forEach var="item" items="${moreItems}">
                    <div style="display:flex;align-items:center;gap:16px;padding:14px 16px;border:1.5px solid #f0e8df;border-radius:14px;margin-bottom:10px;cursor:pointer;transition:all 0.2s;"
                        ...
                        <div
                            ...
                            <i class="${item.icon}" style="color:#E46B39;font-size:18px;"></i>
                        </div>
                        <div>
                            <div style="font-weight:700;color:#46331F;font-size:14px;">${item.label}</div>
                            <div style="font-size:12px;color:#CE9C6A;">${item.description}</div>
                        </div>
                    </div>
                </c:forEach>
            </div>
