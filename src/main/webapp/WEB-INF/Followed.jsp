                ...
                <c:choose>
                    <c:when test="${empty users}">
                        <div style="text-align: center; padding: 40px 20px; color:#7A5533;">
                            ...
                            <p style="margin: 0; font-size: 15px; font-weight: 600;">You are not following anyone yet.
                            </p>
                            <p style="margin: 4px 0 0; font-size: 13px;">Find interesting foodies in the suggestions on
                                the right!</p>
                        </div>
                    </c:when>
                    <c:otherwise>
                            ...
                            <c:forEach var="u" items="${users}">
                                <div id="${u.id}"
                                    ...
                                    <div style="display:flex;align-items:center;gap:12px;min-width:0;">
                                        ...
                                        <div style="display:flex;flex-direction:column;min-width:0;">
                                            <a class="menu" href="ViewProfile?uid=${u.id}"
                                                ...
                                                <c:if test="${not empty u.title}"><c:out value="${u.title}"/> </c:if><c:out value="${u.firstName}"/>
                                    ...
                                    <button type="button" class="unfollowUser"
                                        aria-label="Unfollow ${fn:escapeXml(u.firstName)} ${fn:escapeXml(u.lastName)}"
